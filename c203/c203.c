...
void Queue_Init( Queue *queue ) {
	...
	{
		//nastaveni prvku na '*' a inicializace
...
int Queue_IsFull( const Queue *queue ) {
	//z definici vychazi, ze posledni index+1 pokud se rovna prvnim indexu, tak je fronta plna
	//kontrola jestli pretoku pres maximalni limit fronty pomoci nextindex
