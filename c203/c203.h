...
void Queue_Error( int error_code );					   //DONE

void Queue_Init( Queue *queue );                       //DONE

int Queue_IsEmpty( const Queue *queue );               //DONE

int Queue_IsFull( const Queue *queue );                //DONE

void Queue_Front( const Queue *queue, char *dataPtr ); //DONE

void Queue_Remove( Queue *queue );                     //DONE
